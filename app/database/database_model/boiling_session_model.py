from sqlmodel import SQLModel, Relationship, Field, Enum
...
class FabricBoilingSession(FabricBoilingSessionBase, table=True):
    ...
    esp: Optional["ESP"] = Relationship(back_populates="fabric_boiling_session")
    fabric_type: Optional["FabricType"] = Relationship(back_populates="fabric_boiling_session")
    furnace: Optional["Furnace"] = Relationship(back_populates="fabric_boiling_session")
